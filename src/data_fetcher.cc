...
{
    locations_[PORTS] =
        DataLocation("catppuccin/catppuccin", "resources/ports.porcelain.json", "resources/ports.porcelain.schema.json",
                     "a1ce9a7c29c6aa323f43caa88f21bf51faa91c3a");

    locations_[USERSTYLES] = DataLocation("catppuccin/userstyles", "scripts/userstyles.yml",
                                          "scripts/userstyles.schema.json", "4ee2fffe0492ec2be6d744f770a1cdaa98226d44");

    locations_[CATEGORIES] =
        DataLocation("catppuccin/catppuccin", "resources/categories.yml", "resources/categories.schema.json",
                     "a1ce9a7c29c6aa323f43caa88f21bf51faa91c3a");
